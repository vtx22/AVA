...
const Notification = () => {
   ...
   return (
      <div className="nav-item absolute right-5 md:right-20 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96 drop-shadow-xl">
         <div className="flex justify-between items-center">
            <div className="flex gap-3">
               <p className="font-semibold text-lg dark:text-gray-200">Notifications</p>
               <button type="button" className="text-white text-xs rounded p-1 px-2 bg-orange-theme "> 5 New</button>
            </div>
            <button type='button' onClick={() => handleClick('notification')} style={{ color: 'rgb(153,171,180)', borderRadius: '50%' }} className="text-2xl p-3 hover:drop-shadow-xl hover:bg-light-gray">
               <MdOutlineCancel />
            </button>
         </div>
         <div className="mt-5 ">
